...
describe("E2E tests", function () {
  ...
  describe("Daily Calorie Counter Tests", () => {
    ...
    it("Add Meal", async () => {
      ...
      const [food] = await page.$$eval(`#food`, (t) => t.map((s) => s.value));
      const [time] = await page.$$eval(`#time`, (t) => t.map((s) => s.value));
    ...
    it("Delete Meal", async () => {
      ...
      await Promise.all([onResponse(), page.click(`#list .meal .delete-meal`)]);
